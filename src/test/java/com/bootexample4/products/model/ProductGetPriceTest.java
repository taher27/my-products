...
public class ProductGetPriceTest {
	...
	public void testDefaultPriceValue() {
		assertEquals(0.0, product.getPrice(), "Default price value should be 0.0");
	}
	...
	public void testPriceValueAfterSetting() {
		...
		assertEquals(expectedPrice, actualPrice, "The returned price should be the same as the set value");
	}
	...
	public void testNegativePriceValue() {
		...
		product.setPrice(expectedPrice);
		double actualPrice = product.getPrice();
		assertEquals(expectedPrice, actualPrice, "The returned price should be the same as the set negative value");
	}
	...
	public void testZeroPriceValue() {
		...
		product.setPrice(expectedPrice);
		double actualPrice = product.getPrice();
		assertEquals(expectedPrice, actualPrice, "The returned price should be zero");
	}
