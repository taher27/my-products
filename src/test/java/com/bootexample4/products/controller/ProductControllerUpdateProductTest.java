...
public class ProductControllerUpdateProductTest {
	...
	// This test case will fail as there is no check on price in the business logic.
	// Suggestion: Add a price validity check in the business logic function
	// updateProduct.
	@Test
    public void testProductUpdateWithInvalidDetails() {
        when(productRepository.findById(1L)).thenReturn(Optional.of(existingProduct));
        updatedProduct.setPrice(-1.0);
        assertThrows(IllegalArgumentException.class, () -> productController.updateProduct(1L, updatedProduct));
    }
