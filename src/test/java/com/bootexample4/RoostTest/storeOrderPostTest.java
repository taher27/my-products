...
public class storeOrderPostTest {
	...
	public void setUp() {
		...
		String[] envVarsList = { "" };
		envList = dataloader.load("src\\test\\java\\com\\bootexample4\\RoostTest\\store_orderPostTest.csv",
				envVarsList);
	}
	...
	public void storeOrderPost_Test() throws JSONException {
		...
		for (Map<String, String> testData : envList) {
			...
			Response responseObj = given().header("body", testData.get("body") != null ? testData.get("body") : "")
				.when()
				.post("/store/order")
				.then()
				.extract()
